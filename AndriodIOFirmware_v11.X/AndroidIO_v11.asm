...
;   set_statusregister  pinnumber, statusnumber, function
;   set_status_and_value pinnumber, function, value
;   set_valueregister pinnumber, value
;
;   Pinnumber is 0..47. 0=A0, 1=A1, ... 21=C5, 40=S, 45=X, 46=Y, 47=Z
;   statusnumber is 0..3 for status-0, status-1, status-2 and status-3 register
;
; e.g. to set B3 as ADC with 10 readings and sum:
;   set_statusregister .11, 0, 3
;   set_statusregister .11, 1, b'10'
;   set_statusregister .11, 2, .10
;
; e.g. to use pin B1 as PWM with value 75:
; set_status_and_value .9, .5, .75
;
	return
